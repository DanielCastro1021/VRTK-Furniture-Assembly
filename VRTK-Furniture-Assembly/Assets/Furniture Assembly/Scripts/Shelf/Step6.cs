...
public class Step6 : MonoBehaviour
{
    ...
    public void OnStep6()
    {
        //Destroy Step Piece 5
        GameObject[] prefab_sp = GameObject.FindGameObjectsWithTag("step-piece-5");
        ...
        //Destroy Piece 6
        GameObject[] prefabs_p = GameObject.FindGameObjectsWithTag("piece-6");
        foreach (GameObject prefab_1 in prefabs_p)
        {
            DestroyImmediate(prefab_1);
        }

        //Destroy SnapDropZone 6
        GameObject[] prefab_sdz = GameObject.FindGameObjectsWithTag("sdzone-6");
